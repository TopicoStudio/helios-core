...
export class DistributionIndexProcessor extends IndexProcessor {
    ...
    public async loadModLoaderVersionJson(): Promise<VersionJsonBase> {
        ...
        const modLoaderModule = server.modules.find(({ rawModule: { type } }) => type === Type.ForgeHosted || type === Type.Forge || type === Type.Fabric || type === Type.Neoforge)
        ...
        if(modLoaderModule.rawModule.type === Type.Fabric || modLoaderModule.rawModule.type == Type.Neoforge
